...
import numpy as np
import pprint
import bak_reprogramming_model
...
def main():
    ...
    logging.basicConfig(filename=f'./rlm_log/Our_RLM_{args.vision_model}_{str(args.nums)}log', level=logging.INFO,format='%(asctime)s - %(levelname)s - %(message)s')
    ...
    reprogrammer = bak_reprogramming_model.ReprogrammingFuntion(vocab_size, args.img_patch_size,
        args.img_size,
