...
text_dataset_configs = {
    ...
    # Summary	commit_message	func_after	func_before
    'assessment_Dataset': {
        'data_files': None,
        'sentence_mapping': 'text',
        'subset': None,
    ...
    # 'Vulnerability_Dataset': {
    #     'data_files': {
    #         'train': ['/data/rqiu/multimodal_rerprogramming/dataset/vuldeepecker/vuldeepecker_train.pkl'],
    #         'test': ['/data/rqiu/multimodal_rerprogramming/dataset/vuldeepecker/vuldeepecker_test.pkl']
    #     },
    #     'sentence_mapping': 'text',
    #     'num_labels': 2,
    #     'subset': None,
    #     'val_split': 'test'
    # },
    # sentence_mapping val_split:I don’t know anything, just write as above
